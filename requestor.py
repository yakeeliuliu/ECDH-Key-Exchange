...
sock.sendto(b'curve=NIST192p',((remote_ip, remote_port)))
sock.sendto(local_public_key_string, (remote_ip, remote_port))
sock.sendto(signature, (remote_ip, remote_port))
print("-----Primes, public key and signature have been sent to remote machine\n------Starting listiening...")
...
if received_curve.decode('utf-8') == 'curve=NIST192p':
    ...
    print("------------Received remote suite, caculating shared key...")
